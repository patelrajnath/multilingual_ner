...
df.to_csv('data/tweeter_nlp/ner.txt.train_normalized.csv', sep='\t', index=False)
# df.to_csv('data/GMB/ner_normalized.csv', sep='\t', index=False)
# df.to_csv('data/kaggle-ner/ner_normalized.csv', sep='\t', index=False)
